export default function validate (input){
    ...
    if(input.Temperaments.length === 0) {
        errors.Temperaments = "The dog must be contain, at least, one Temperaments."
    } else if (input.Temperaments.length > 8) {
        errors.Temperaments = "The dog can't have more than eigth Temperamentss."
    }
